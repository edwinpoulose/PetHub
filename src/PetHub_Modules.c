/*=============================================================================
    File Name:  PetHub_Modules.c  
    Author:     Edwin Poulose
    Date:       28/05/2024
    Modified:   None
    � Fanshawe College, 2024

    Description: This program contains all the sub modules used by the main function
=============================================================================*/
...
void systemInitialization(void)
{
    ...
    // Initializing all system settings to initial status
    initStepper(&vent);
    initPbs(&pbs);
...
Date:       27/05/2024
Modified:   None
Desc:       Initialize push button data structure
...
Date:       27/05/2024
Modified:   None
Desc:       Initialize stepper motor data structure
...
Date:       27/05/2024
Modified:   None
Desc:       Initialize status data structure
...
Date:       27/05/2024
Modified:   None
Desc:       Initialize time data structure
...
Date:       27/05/2024
Modified:   None
Desc:       Initialize schedule data structure
